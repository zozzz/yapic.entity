 ...
 *                     result = _convert_record(stack, record, poly_rco, state)
 */
            __pyx_t_17 = __Pyx_PyList_Pop(__pyx_v_stack); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 76, __pyx_L12_except_error)
            __Pyx_GOTREF(__pyx_t_17);
            __Pyx_DECREF_SET(__pyx_v_result, __pyx_t_17);
            __pyx_t_17 = 0;
            __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
            __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
            __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 */
        __pyx_t_16 = __Pyx_PyInt_As_int(__pyx_v_rco->param1); if (unlikely((__pyx_t_16 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 80, __pyx_L1_error)
        __pyx_t_11 = __Pyx_GetItemInt(__pyx_v_record, ((int)__pyx_t_16), int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 80, __pyx_L1_error)
 ...
 *                 if tmp:
 */
        __pyx_t_16 = __Pyx_PyInt_As_int(__pyx_v_rco->param1); if (unlikely((__pyx_t_16 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 86, __pyx_L1_error)
        __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_record, ((int)__pyx_t_16), int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 86, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_XDECREF_SET(__pyx_v_tmp, __pyx_t_2);
        __pyx_t_2 = 0;
 ...
 */
          if (likely(PyList_CheckExact(__pyx_v_tmp)) || PyTuple_CheckExact(__pyx_v_tmp)) {
            ...
            __Pyx_GOTREF(__pyx_t_2);
            __pyx_t_18 = __Pyx_PyObject_GetIterNextFunc(__pyx_t_2); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 89, __pyx_L1_error)
          }
          for (;;) {
