 ...
 * 
 */
  if (!(likely(PyTuple_CheckExact(__pyx_v_depends))||((__pyx_v_depends) == Py_None)||((void)PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_v_depends)->tp_name), 0))) __PYX_ERR(0, 16, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_ptype_5yapic_6entity_11_expression_BinaryExpression = __Pyx_ImportType_0_29_35(__pyx_t_2, "yapic.entity._expression", "BinaryExpression", sizeof(struct __pyx_obj_5yapic_6entity_11_expression_BinaryExpression), __PYX_GET_STRUCT_ALIGNMENT_0_29_35(struct __pyx_obj_5yapic_6entity_11_expression_BinaryExpression),__Pyx_ImportType_CheckSize_Warn_0_29_35); if (!__pyx_ptype_5yapic_6entity_11_expression_BinaryExpression) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  __pyx_ptype_5yapic_6entity_11_expression_OrderExpression = __Pyx_ImportType_0_29_35(__pyx_t_2, "yapic.entity._expression", "OrderExpression", sizeof(struct __pyx_obj_5yapic_6entity_11_expression_OrderExpression), __PYX_GET_STRUCT_ALIGNMENT_0_29_35(struct __pyx_obj_5yapic_6entity_11_expression_OrderExpression),__Pyx_ImportType_CheckSize_Warn_0_29_35); if (!__pyx_ptype_5yapic_6entity_11_expression_OrderExpression) __PYX_ERR(0, 1, __pyx_L1_error)
